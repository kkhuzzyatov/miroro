...
/**
 * ключ группировки: product + color
 */
...
export default function ProductsContainer() {
  ...
  /**
   * строим уникальные карточки:
   * одна карточка = один цвет товара
   */
  const grouped: ProductColorGroup[] = useMemo(() => {
    ...
    for (const product of filtered) {
      ...
      for (const variant of product.variants) {
        ...
        result.push({
          ...
          variantId: variant.id // любой size внутри этого цвета
        });
      }
    }
